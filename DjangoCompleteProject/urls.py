"""
URL configuration for DjangoCompleteProject project.
...
urlpatterns = [
    ...
    path('add-prod/', my_views.add_products, name='add-products-url'),
    path('view-prod/', my_views.view_products, name='view-products-url'),
